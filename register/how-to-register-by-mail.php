<html lang="en-US" class="jetpack-lazy-images-js-enabled"><head>
	...
	<title>How to Register by Mail – County Name Elections</title>
...
<main class="post-60 page type-page status-publish hentry">
		<h1>How to Register by Mail</h1>
	
	
<p>You can register to vote by filling out the state or national voter registration form and mailing it in to the [Insert: County] Elections office. If you don’t have a printer, you can <a rel="noreferrer noopener" href="Link]" target="_blank">register online</a> instead. If you’re living in another country, see info on military and overseas voting.</p>
...
<section class="wp-block-ctcl-election-website-numbered-section-block numbered-section"><div class="numbered-section-content">
<h2>Fill out a Registration Form</h2>



<p>You can use either of these forms:</p>



<ul><li><a href="./register-form.php" target="_blank" rel="noreferrer noopener">[Insert: State Name] Voter Registration Form</a></li></ul>
</div></section>



<section class="wp-block-ctcl-election-website-numbered-section-block numbered-section"><div class="numbered-section-content">
<h2>Mail in the Registration Form</h2>



<p>Where to mail your Voter code:</p>
...
<p><strong>[Insert: County] Elections Commission Office</strong><br>[Insert: Email]<br>[Insert:Phone Number]<br>[Insert: City], [Insert: State]</p>
</div></section>
</div></div>
