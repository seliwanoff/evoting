...
<section style="padding: 10px; margin:20px auto;width:100%">
    ...
    <label for="post">PARTICAPATING PARTIES:</label>
...
if($num){
  while($fetch = mysqli_fetch_array($query)){
    ?>
      ...
      <td><?php echo $fetch['pparties']?> </td>
      <td>
        <a href='./totalvote.php?type="<?php echo $fetch['id']?>"'>
      <button class="btn btn-primary">Get Total vote</button>
      </a>
    </td>
