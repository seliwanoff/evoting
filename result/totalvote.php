...
<section class="banner major banner-dark">
	<div class="banner-wrapper">
		<div>
			...
			<p>E-voting allows any voter who can't vote in person to vote by absentee ballot.</p>
					</div>
...
<section style="padding: 10px; margin:20px auto;width:100%">

    <div style="width:100%; margin-top: 60px;">
    
    <label for="post">VOTE REALIZED BY EACH PARTY:</label>
...
$select= "SELECT * FROM `polling` WHERE `pd`='".$_GET['type']."'";
  ...
  <?php
    ...
    ?>
         <div class="alert alert-danger" role="alert">
                  No Vote realized for this party.
        </div>
    <?php
